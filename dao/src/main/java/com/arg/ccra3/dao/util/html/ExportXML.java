...
public class ExportXML implements ExportFileElements
{
    ...
    private Hashtable httpServletRequest = null;
    ...
    public void setHttpServletRequest(Hashtable httpServletRequest)
    {
            ...
            throws Exception
    {
        ...
        //Start Insert <exec-company-name>
        if (reportVersion == 2)
        {
            try
            {
...
//            if (null != p_lo.getCityLO()            //modify per kim request to display only address 1, 2, 3
//                    && 0 != p_lo.getCityLO().length())
//            {
//                tmp = tmp + "\n" + p_lo.getCityLO();
//            }
//            if (null != p_lo.getProvinceLO()
//                    && 0 != p_lo.getProvinceLO().length())
//            {
//                tmp = tmp + "\n" + p_lo.getProvinceLO();
//            }
//            if (null != p_lo.getCountry() &&
//                    0 != p_lo.getCountry().length())
//            {
//                tmp = tmp + "\n" + p_lo.getCountry();
//            }
//            if (null != p_lo.getPostCode() &&
//                    0 != p_lo.getPostCode().length())
//            {
//                tmp = tmp + "\n" + p_lo.getPostCode();
//            }
        }
...
//        if (null != p_lo.getCity()        //modify per kim request to display only address 1, 2, 3
//                && 0 != p_lo.getCity().length())
//        {
//            tmp = tmp + "\n" + p_lo.getCity();
//        }
//        if (null != p_lo.getProvince()
//                && 0 != p_lo.getProvince().length())
//        {
//            tmp = tmp + "\n" + p_lo.getProvince();
//        }
//        if (null != p_lo.getCountry() &&
...
//            SimpleDateFormat simpleDateFormatNegativeReport2 =
//                    new SimpleDateFormat("MMMMMMMMMM yyyy", Locale.ENGLISH);
                            ...
                            .intValue())
            {
                ...
                XMLUtil.getCData(ReportResourceJson.getMessage(preLang.getLocale(),
                            ...
                            ExportFileElements.TYPE, sb);
//                XMLUtil.getCData(
//                        ExportFileElements.REPORT_FINANCE_TYPE_AGGREGATE,
//                        ExportFileElements.TYPE, sb);
                XMLUtil.getCData(
                            ...
                            .intValue())
            {
                ...
                XMLUtil.getCData(ReportResourceJson.getMessage(preLang.getLocale(),
                            ...
                            ExportFileElements.TYPE, sb);
//                XMLUtil.getCData(
//                        ExportFileElements.REPORT_FINANCE_TYPE_REVOLVING,
//                        ExportFileElements.TYPE, sb);
                XMLUtil.getCData(
                            ...
                            .intValue())
            {
                ...
                XMLUtil.getCData(ReportResourceJson.getMessage(preLang.getLocale(),
                            ...
                            ExportFileElements.TYPE, sb);
//                XMLUtil.getCData(
//                        ExportFileElements.REPORT_FINANCE_TYPE_NONREVOLVING,
//                        ExportFileElements.TYPE, sb);
                XMLUtil.getCData(
                            ...
                            .intValue())
            {
                ...
                XMLUtil.getCData(ReportResourceJson.getMessage(preLang.getLocale(),
                            ...
                            ExportFileElements.TYPE, sb);
//                XMLUtil.getCData(
//                        ExportFileElements.REPORT_FINANCE_TYPE_CONTINGENT,
//                        ExportFileElements.TYPE, sb);
                XMLUtil.getCData(
                            ...
                            .intValue())
            {
                ...
                XMLUtil.getCData(ReportResourceJson.getMessage(preLang.getLocale(),
                            ...
                            ExportFileElements.TYPE, sb);
//                XMLUtil.getCData(
//                        ExportFileElements.REPORT_FINANCE_TYPE_HPLEASING,
//                        ExportFileElements.TYPE, sb);
                XMLUtil.getCData(
