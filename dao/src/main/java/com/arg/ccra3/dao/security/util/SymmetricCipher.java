...
public final class SymmetricCipher
{
  ...
  private final Logger logger = (Logger) LoggerFactory.getLogger(this.getClass());
    ...
    private SymmetricCipher() throws Exception
    {
        ...
        logger.info("defaultCipher>>>"+ defaultCipher);
        logger.info("DEFAULT_SECRET_KEY_TEXT>>>"+ DEFAULT_SECRET_KEY_TEXT);
        logger.info("defaultKey>>>"+ new Base64().encodeToString(defaultKey.getEncoded()));
