...
//        try
//        {
//            XMLUtil.getCData(rhd.getCountryCode(), ExportFileElements.COUNTRY_CODE, sb);
//        }
//        catch (Exception e)
//        {
//            XMLUtil.getBlankElement(ExportFileElements.COUNTRY_CODE, sb);
//        }
        try
        {
...
//        try
//        {
//            XMLUtil.getCData(rhd.getCompanyName(), "company-name", sb);
//        }
//        catch (Exception e)
//        {
//            XMLUtil.getBlankElement("company-name", sb);
//        }
        XMLUtil.getCData(
    ...
    public void getRequestForm()
    {
        ...
        enumeration = httpServletRequest.keys();
