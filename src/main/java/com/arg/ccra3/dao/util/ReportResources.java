...
public class ReportResources {
    ...
    static
    {
        ...
        catch (MissingResourceException e)
        {
            ...
            catch (MissingResourceException e1)
            {
                ...
                {
                    int index;
                    package_name = OIStatement.class.getName();
        ...
        for (Enumeration<String> enu = BUNDLE_EN.getKeys(); enu.hasMoreElements();)
        {
        ...
        for (Enumeration<String> enu = BUNDLE_ZH.getKeys(); enu.hasMoreElements();)
        {
            key = (String) enu.nextElement();
    ...
    public static String getString(final String key, final String vars,
        Locale locale)
    {
        return getString(key, new String[] { vars }, locale);
    }
