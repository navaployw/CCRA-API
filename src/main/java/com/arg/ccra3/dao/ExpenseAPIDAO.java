...
public class ExpenseAPIDAO {
    ...
    private static final Logger logger = LogManager.getLogger(ExpenseAPIDAO.class);
    ...
    public Long saveReportExpense(Integer uid, Integer ugid, Integer uaiid, Integer cbuid, int objID, Long tokenID, Date requestTime, Date responseTime, AIOrderDAO aiDao) {
        ...
        switch (objID) {
            case OBJECT_TYPE.BASIC_REPORT-> {
                expense.setProductusage(OBJECT_TYPE.BASIC_REPORT_API);
            }
            case OBJECT_TYPE.CHINESE_REPORT-> {
                expense.setProductusage(OBJECT_TYPE.CHINESE_REPORT_API);
            }
