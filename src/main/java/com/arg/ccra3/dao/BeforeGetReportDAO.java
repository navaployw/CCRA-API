...
public class BeforeGetReportDAO {
    ...
    public List<SpmTransaction> insertApiSpmTransaction(Integer sessionId, BigDecimal uid, BigDecimal groupAiId, BigDecimal groupId,Integer expense) {
        ...
        String sql = "INSERT INTO API_SPM_TRANSACTION (sessionId, uid, groupaiid, groupid, objectid,dataid, channel, amountresult, createdby, createddate,updatedby,updateddate) VALUES(?,?,?,?,202,null,'A',?,?,getDate(),?,getDate()); SELECT * FROM API_SPM_TRANSACTION WHERE TRANSACTIONID = SCOPE_IDENTITY()";
