...
public class CtrlKey {
    ...
    public String toString() {
        return "CtrlKey{" + "ctrlId=" + ctrlId + ", ctrlType=" + ctrlType + ", ctrlValue=" + ctrlValue + ", ctrlDescription=" + ctrlDescription + ", ctrlStart=" + ctrlStart + ", ctrlEnd=" + ctrlEnd + ", ctrlFlag=" + ctrlFlag + '}';
    }
