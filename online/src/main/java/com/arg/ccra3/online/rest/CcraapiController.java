...
public class CcraapiController {
        ...
        if (!CDITokenBody.equals("Error")) {
            ...
            try {
                if (tokenApi.isEmpty()) {
                    ...
                    trnJsonObjResponse.setStatusCode(message.get(0).getStatusCode()!=null?message.get(0).getStatusCode()!=null?Long.parseLong(message.get(0).getStatusCode().toString()):null:null);
                    ...
                    if (userList.size() == 1) {
                        ...
                        if (!apiCtrlService.allowCDITokenDuplicate()) {
                            ...
                            if (!cdiTokenList.isEmpty()) {
                                List<MessageError> message = messageErrorService.getMessageByCode("00044");
                                res.setCode(message.get(0).getErrorCode());
                                res.setMessage(message.get(0).getErrorMessage());
                                ...
                                trnJsonObjResponse.setErrorCode(message.get(0).getErrorCode());
                                trnJsonObjResponse.setStatusCode(message.get(0).getStatusCode()!=null?Long.parseLong(message.get(0).getStatusCode().toString()):null);
                                trnJson.saveJsonResponse(trnJsonObjResponse);
                                return ResponseEntity.status(message.get(0).getStatusCode()).body(res);
                            }
                        }
                        ...
                        //AI_CODE Request AND AI_CODE in CCRA token
                        if (!aiCCRA.equals(aiOut)) {
                            ...
                            trnJson.saveJsonResponse(trnJsonObjResponse);
                            return ResponseEntity.status(message.get(0).getStatusCode()).body(res);
                        } //AI_CODE Request AND AI_CODE in CDI token
                            ...
                            trnJson.saveJsonResponse(trnJsonObjResponse);
                            return ResponseEntity.status(message.get(0).getStatusCode()).body(res);
                        } //COMPANY_ID Request AND COMPANY_ID in CDI token
                            ...
                            try {
                                ...
                                if (userId.equals(userList.get(0).getUserID())) {
                                    ...
                                    logger.info(loggerText);
                                    loggerText = String.format("msgErr:ErrorCode: %s", msgErr.getErrorCode());
                                    logger.info(loggerText);
                                    if (msgErr.getErrorCode() != null) {
                                        ...
                                        trnJsonObjResponse.setStatusCode(msgErr.getStatusCode()!=null?Long.parseLong(msgErr.getStatusCode().toString()):null);
                                        trnJson.saveJsonResponse(trnJsonObjResponse);
                                        return ResponseEntity.status(msgErr.getStatusCode()!=null?msgErr.getStatusCode():500).body(res);
                                    } else {
                                        res.setCode("200");
                                        ...
                                        requestModelTemp.setMatchTranId(msgErr.getTransactionId() != null ? Long.parseLong(msgErr.getTransactionId().toString()): null);
                                        trnJson.saveJsonResponse(trnJsonObjResponse);
                                    }
                                } else {
                                    logger.info(">>!userId.equals(userList.get(0).getUserID())<<");
    ...
    public static String getBearerTokenHeader() {
        return ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest().getHeader("Authorization").split(" ")[1];
    }
